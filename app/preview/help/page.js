...
const FAQ_FALLBACK = [
  ...
  ['What is the Spinr Pass?', 'It is the monthly subscription a driver pays for access to the Spinr app \u2014 dispatch, in-app payments, support. It replaces commission entirely: Spinr never takes a percentage of a driver\u2019s fare. Every driver gets 6 months free at the moment. After that there are two monthly plans set by how many rides a day you take: Part-time at $19.99 a month, an introductory rate, covering up to 4 rides a day; and Full-time at $49.99 a month with unlimited rides.'],
  ['What happens when I hit 4 rides on the Part-time plan?', 'That is your limit for the day \u2014 you will not be offered more rides until the next day, when it resets. If you are reaching it often, the Full-time plan is $49.99 a month with unlimited rides.'],
