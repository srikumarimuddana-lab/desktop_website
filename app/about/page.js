          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-500 mb-8 leading-relaxed max-w-lg">
                Innovation meets community in every ride. We're proudly Canadian, redefining urban mobility with <span className="text-gray-900 font-semibold">0% commission</span> for drivers and <span className="text-gray-900 font-semibold">100% net fare</span> for everyone.
              </p>
              <Link href="#mission">
