...
export function normalizePromotion(row) {
  ...
  return {
    ...
    reminderSmsTemplate: row.reminder_sms_template || DEFAULT_REMINDER_TEMPLATE,
...
export function toDbRow(p) {
  const out = {
    ...
    reminder_sms_template: p.reminderSmsTemplate || DEFAULT_REMINDER_TEMPLATE,
  }
  return out
}
...
export { DEFAULT_SMS_TEMPLATE, DEFAULT_REMINDER_TEMPLATE }
